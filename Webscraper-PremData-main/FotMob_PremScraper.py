...
DRIVER_PATH = 'chromedriver' # YOUR PATH GOES HERE
...
sel = Select(driver.find_element(By.CLASS_NAME, ('css-ph6ea9-Select')))
sel.select_by_value (str(MATCHWEEK))
#%%
#Block to retrieve match links for the matchweek
match_divs = driver.find_elements(By.CLASS_NAME,('css-1ty7xja-LeagueMatchCSS'))
match_links = []
...
def get_match_stats(driver, match_link):
    ...
    div1 = driver.find_element(By.CLASS_NAME,('css-hhl4y6-MFStatsContainer'))
    statsContainers = div1.find_elements(By.CLASS_NAME,('css-1khnrgx-StatsContainer'))
    ...
    header = driver.find_element(By.CLASS_NAME, ('eb9uzl80'))
    match_info = header.find_elements(By.TAG_NAME, ('span'))
    ...
    possession_graph = statsContainers[0].find_element(By.CLASS_NAME, ('css-pqh9gi-MFSGraphContainer'))
    possession_nums = possession_graph.find_elements(By.TAG_NAME, ("div"))
    ...
    for statContainer in statsContainers:
        statRowWrappers = statContainer.find_elements(By.CLASS_NAME,('e1car83v2'))
        for statRowWrapper in statRowWrappers:
            statRow = statRowWrapper.find_elements(By.TAG_NAME, ('span'))
